...
public class DbConnectivityClass {
    final static String DB_NAME="CSC311_BD_TEMP";
        ...
        final static String SQL_SERVER_URL = "jdbc:mysql://csc311lokhandwalaserver.mysql.database.azure.com";//update this server name
        ...
        final static String PASSWORD = "C0mpl3X!ty";// update this password
